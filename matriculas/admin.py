...
class CarreraAdmin(admin.ModelAdmin):
    list_display = ('id','nombre','estado','semestres')
...
class MatriculaAdmin(admin.ModelAdmin):
    list_display = ('id','estudiante','carrera','modalidad','periodo','estado','fecha_matricula')
...
class PagoAdmin(admin.ModelAdmin):
    list_display = ('id','matricula','fecha_pago','monto','metodo','estado')
    list_filter = ('metodo',)
